module github.com/iotaledger/inx-coordinator/tools/gendoc

go 1.21

replace github.com/iotaledger/inx-coordinator => ../../
...
require (
	...
	github.com/iotaledger/inx-coordinator v0.0.0-00010101000000-000000000000
)
...
require (
	...
	github.com/iotaledger/hornet/v2 v2.0.0-rc.8 // indirect
	github.com/iotaledger/inx-app v1.0.0-rc.3.0.20230808143959-5d2dd5f23266 // indirect
